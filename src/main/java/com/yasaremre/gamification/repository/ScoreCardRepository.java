package com.yasaremre.gamification.repository;
...
public interface ScoreCardRepository extends CrudRepository<ScoreCard, Long> {
     ...
     */
    @Query("SELECT SUM(s.score) FROM com.yasaremre.gamification.domain.ScoreCard s WHERE s.userId = :userId GROUP BY s.userId")
     ...
     */
    @Query("SELECT NEW com.yasaremre.gamification.domain.LeaderBoardRow(s.userId, SUM(s.score)) " +
            "FROM com.yasaremre.gamification.domain.ScoreCard s " +
